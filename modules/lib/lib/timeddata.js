...
// public
TimedData.prototype.getValue = function () {
...
// public
TimedData.prototype.inc = function (value) {
...
// public
TimedData.prototype.dec = function (value) {
	if (!value || isNaN(value)) {
		return false;
	}
...
// public
TimedData.prototype.reset = function () {
	this.current = this.conf.init;
	this.lastUpdate = Date.now();
};

// public
TimedData.prototype.getMaxValue = function () {
	return this.conf.max;
};

// public
TimedData.prototype.getMinValue = function () {
	return this.conf.min;
};

// public
TimedData.prototype.getInterval = function () {
	return this.conf.interval;
};

// public
TimedData.prototype.getStep = function () {
	return this.conf.step;
};

// public
TimedData.prototype.getLastUpdate = function () {
	return this.lastUpdate;
};

// public
TimedData.prototype.toObject = function () {
	var obj = {};
...
// private
TimedData.prototype.validate = function (conf) {
...
// private
TimedData.prototype.calculateCurrentValueForInc = function () {
...
// private
TimedData.prototype.calculateCurrentValueForDec = function () {
