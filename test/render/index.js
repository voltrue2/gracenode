...
describe('gracenode.render', function () {
	...
	it('can render a template', function () {
		...
		expected += ' src="/test/list/2"></script></head><body><div class="whatever">Foo</div><div>Required!!</div>';
		...
		expected += '<div>Test&nbsp;60</div><div>Test&nbsp;70</div><div>Test&nbsp;80</div><div>Test&nbsp;90</div><div>Test&nbsp;100</div></body></html>';		
