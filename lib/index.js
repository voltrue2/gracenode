...
// performce a binary search on an array of objects based on the given "key"
module.exports.bsearch = function (list, key, value) {
	var min = 0;
...
// performce a semi binary search by range on an array of objects based on the given "key"
// it is fast because the has to loop /2 of the length of the target array
module.exports.brange = function (list, key, min, max) {
	if (!list.length) {
		return [];
	}
	var res = [];
